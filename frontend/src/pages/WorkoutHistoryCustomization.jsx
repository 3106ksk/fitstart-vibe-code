import { ArrowLeftIcon, CheckIcon, FireIcon, HeartIcon } from '@heroicons/react/24/outline';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm border">
              <h2 className="text-lg font-semibold text-gray-900 mb-4">プリセット</h2>
            ...
            {/* セット数設定 */}
            <div className="bg-white rounded-lg p-6 shadow-sm border">
              <h2 className="text-lg font-semibold text-gray-900 mb-4">セット数</h2>
              <p className="text-sm text-gray-600 mb-4">筋トレ系種目の履歴テーブルに表示するセット数を選択</p>
              <div className="grid grid-cols-3 gap-3">
                {[1, 2, 3].map((sets) => (
                  <button
                    key={sets}
                    onClick={() => handleMaxSetsChange(sets)}
          ...
          <div className="space-y-6">
            ...
            {workoutConfig.exercises.length < 3 && (
              <div className="bg-white rounded-lg p-6 shadow-sm border">
                <h2 className="text-lg font-semibold text-gray-900 mb-4">種目を追加</h2>
